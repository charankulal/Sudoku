...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private HashMap<Coordinates,SudokuTextField> textFieldHashMap;
    ...
    private static final Color BOARD_BACKGROUND_COLOR=Color.rgb(224,242,240);
    ...
    private void drawTextFields(Group root) {
        ...
        for(int xIndex=0;xIndex<9;xIndex++)
        {
            for (int yIndex=0;yIndex<9;yIndex++)
            {
                ...
                textFieldHashMap.put(new Coordinates(xIndex,yIndex),tile);
    ...
    public void updateSquare(int x, int y, int input) {
        SudokuTextField tile=textFieldHashMap.get(new Coordinates(x,y));
    ...
    public void updateBoard(SudokuGame game) {
        for (int xIndex=0;xIndex<9;xIndex++)
        {
            for(int yIndex=0;yIndex<9;yIndex++)
            {
                TextField tile=textFieldHashMap.get(new Coordinates(xIndex,yIndex));
